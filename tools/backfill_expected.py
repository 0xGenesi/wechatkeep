...
# 官方 CDN 构建归档直链（2026-09-19 发现）：按 营销版本_构建号 归档 dmg，
# 非 XZ、无速率限制——优先于 zsbai（XZ 损坏频发）。覆盖（2026-09-19 全线
# HEAD 实测）：4.1.15 全家族 + 4.1.13 的 .5-.11/.50-.63 段；4.1.13.12-.49
# 段（含 269602）、4.1.12 及更老线 404（回落 zsbai）。
...
# 4.1.13 线 20 条映射 = 2026-09-19 官方 CDN 归档直链逐一 HEAD 实证
# （xWeChatMac_universal_4.1.13.<N>_<269568+N>.dmg 全线 200/404 核对；
# 早期版本的 269578/579/619 等旧值是从 zsbai DestVersion 猜的邻接映射，
# 实为错位——4.1.13.59 是 269627 的 tag 而非 269579 的）。
# 更老线（4.1.12 及以下）CDN 无归档（2026-09-19 抽测全线 404），hints 仍为
# zsbai 猜测值，含已知自相矛盾（268849/268851 同标 4.1.10.31）——挂载后
# 构建号校验兜底，错 hints 只浪费一次下载。
BUILD_TO_TAG_HINTS = {
    ...
    "269618": "4.1.13.50", "269579": "4.1.13.11", "269578": "4.1.13.10",
    "269577": "4.1.13.9", "269576": "4.1.13.8", "269575": "4.1.13.7",
    "269574": "4.1.13.6", "269573": "4.1.13.5", "269602": "4.1.13",
